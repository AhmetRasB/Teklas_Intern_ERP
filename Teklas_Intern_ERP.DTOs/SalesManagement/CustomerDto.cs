    ...
    public sealed class CustomerDtoValidator : AbstractValidator<CustomerDto>
    {
        public CustomerDtoValidator()
        {
            RuleFor(x => x.Code)
                ...
                .MinimumLength(2).WithMessage("Customer code must be at least 2 characters")
            ...
            RuleFor(x => x.CustomerType)
                ...
                .When(x => !string.IsNullOrEmpty(x.CustomerType));
            ...
            RuleFor(x => x.SalesRepresentative)
                .MaximumLength(100).WithMessage("Sales representative cannot exceed 100 characters")
                .When(x => !string.IsNullOrEmpty(x.SalesRepresentative));
