...
@media (max-width: 900px) {
  .material-category-modal-grid { grid-template-columns: 1fr !important; }
}
`;
...
const validationSchema = yup.object().shape({
  Code: yup.string().required('Kategori kodu zorunludur.').max(50, 'Kategori kodu en fazla 50 karakter olabilir.'),
  Name: yup.string().required('Kategori adı zorunludur.').max(100, 'Kategori adı en fazla 100 karakter olabilir.'),
    ...
    <div style={modalOverlayStyle}>
      ...
      <div style={{...a4LandscapeStyle, ...modalBg}} className="a4-landscape-modal">
        ...
        <Form onSubmit={handleSubmit} style={{flex: 1, overflow: 'auto'}}>
          ...
          <div style={gridStyle} className="material-category-modal-grid">
            <div>
            ...
            <div>
              <Form.Group className="mb-3">
                ...
                <Form.Select name="ParentCategoryId" value={form.ParentCategoryId || ''} onChange={onChange} style={inputStyles}>
                  <option value="">Üst Kategori Yok</option>
                  {parentCategories.filter(cat => cat.id !== form.id).map(cat => (
